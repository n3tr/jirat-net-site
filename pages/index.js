  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="Once upon a time. This domain was belong to someone, now it is mine!" />
        <link rel="icon" href="/favicon.ico" />
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta property="og:title" content="There is my name and my nickname in my domain name - Jirat.Net" key="title" />
